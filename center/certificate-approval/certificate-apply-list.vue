...
export default {
    ...
    data(){
        ...
        columns: [
          ...
          {title: '起讫号开始', key: 'empUnit', sortable: true, minWidth: 135},
          {title: '起讫号结束', key: 'goodAt', sortable: true, minWidth: 120},
          {title: '申领数量', key: 'honor', sortable: true, minWidth: 120},
          {title: '申领日期', key: 'honor', sortable: true, minWidth: 120}
        ],
        tableData: [],
        rescueArea:[],//救援区域----
        search:{
