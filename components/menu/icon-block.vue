...
<div class="icon-block" ref="thisBlock" v-show="show" :style="{left: left+'px'}">
  <div class="block" v-show="type==1">
    ...
    <nuxt-link tag="a" to="/guild-article/10281034" target="_blank"><img src="/img/menu-icon/推介服务.png"/><p>推介服务</p></nuxt-link>
  ...
  <div class="block" v-show="type==2">
    ...
    <nuxt-link tag="a" to="/article/parts" target="_blank"><img src="/img/menu-icon/配件需求.png"/><p>配件需求</p></nuxt-link>
  ...
  <div class="block" v-show="type==5">
    ...
    <nuxt-link tag="a" to="/guild-article/10281013" target="_blank"><img src="/img/menu-icon/工作动态.png"/><p>工作动态</p></nuxt-link>
    <nuxt-link tag="a" to="/guild-article/10281014" target="_blank"><img src="/img/menu-icon/行业风采.png"/><p>行业风采</p></nuxt-link>
    <nuxt-link tag="a" to="/guild-article/10281008" target="_blank"><img src="/img/menu-icon/行业能手.png"/><p>行业能手</p></nuxt-link>
    <nuxt-link tag="a" to="/guild-article/10281015" target="_blank"><img src="/img/menu-icon/行业党建.png"/><p>行业党建</p></nuxt-link>
    <nuxt-link tag="a" to="guild-article/10281024/211" target="_blank"><img src="/img/menu-icon/专家组.png" /><p>专家组</p></nuxt-link>
  </div>
  <div class="block" v-show="type==6">
    <nuxt-link tag="a" to="/gov-article/10281030" target="_blank"><img src="/img/menu-icon/培训需求.png"/><p>培训需求</p></nuxt-link>
  </div>
  <div class="block" v-show="type==7">
    <nuxt-link tag="a" to="/guild-article/10281033" target="_blank"><img src="/img/menu-icon/满意度调查.png"/><p>满意度调查</p></nuxt-link>
    <nuxt-link tag="a" to="/feedback" target="_blank"><img src="/img/menu-icon/维修投诉.png"/><p>维修反馈</p></nuxt-link>
  </div>
  <div class="block" v-show="type==8">
    <nuxt-link tag="a" to="/partner" target="_blank"><img src="/img/menu-icon/在线商务.png"/><p>在线商务</p></nuxt-link>
    <nuxt-link tag="a" to="/partner" target="_blank"><img src="/img/menu-icon/商务合作.png"/><p>商务合作</p></nuxt-link>
  </div>
