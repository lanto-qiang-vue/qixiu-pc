...
<div class="icon-block" ref="thisBlock" v-show="show" :style="{left: left+'px'}">
  ...
  <div class="block" v-show="type==4">
    ...
    <nuxt-link tag="a" to="/"><img src="/img/menu-icon/数据需求.png"/><p>数据需求</p></nuxt-link>
    <nuxt-link tag="a" to="/"><img src="/img/menu-icon/汽车读物.png"/><p>汽车读物</p></nuxt-link>
    <nuxt-link tag="a" to="/"><img src="/img/menu-icon/汽车保险.png"/><p>汽车保险</p></nuxt-link>
    <nuxt-link tag="a" to="/"><img src="/img/menu-icon/汽车用品.png"/><p>汽车用品</p></nuxt-link>
    <nuxt-link tag="a" to="/"><img src="/img/menu-icon/汽保设备.png"/><p>汽保设备</p></nuxt-link>
    <nuxt-link tag="a" to="/"><img src="/img/menu-icon/汽车销售.png"/><p>汽车销售</p></nuxt-link>
  </div>
  <div class="block" v-show="type==5">
    <nuxt-link tag="a" to="/"><img src="/img/menu-icon/协会简介.png"/><p>协会简介</p></nuxt-link>
    <nuxt-link tag="a" to="/"><img src="/img/menu-icon/协会职能.png"/><p>协会职能</p></nuxt-link>
    <nuxt-link tag="a" to="/"><img src="/img/menu-icon/工作动态.png"/><p>工作动态</p></nuxt-link>
    <nuxt-link tag="a" to="/"><img src="/img/menu-icon/行业风采.png"/><p>行业风采</p></nuxt-link>
    <nuxt-link tag="a" to="/"><img src="/img/menu-icon/行业能手.png"/><p>行业能手</p></nuxt-link>
    <nuxt-link tag="a" to="/"><img src="/img/menu-icon/行业党建.png"/><p>行业党建</p></nuxt-link>
    <nuxt-link tag="a" to="/"><img src="/img/menu-icon/专家组.png"/><p>专家组</p></nuxt-link>
  </div>
  <div class="block" v-show="type==6">
    <nuxt-link tag="a" to="/"><img src="/img/menu-icon/培训需求.png"/><p>培训需求</p></nuxt-link>
  </div>
