 ...
 * @since 2013-03-15
 */
Ext.define('app.ux.UploadGrid',{
	extend : 'Ext.grid.Panel',
	alias : 'widget.uploadgrid2',
	width : 750,
	height : 300,
	columns : [
        {xtype: 'rownumberer'},
        ...
        {text: '进度', width: 130,dataIndex: 'percent',renderer:function(v){        	
			var stml =
				'<div>'+
					'<div style="border:1px solid #008000;height:15px;width:115px;margin:2px 0px 1px 0px;float:left;">'+		
						'<div style="float:left;text-align:right;background:green;width:'+v+'%;height:13px;" align="right">' + v + '%</div>'+
					'</div>' +
//				'<div style="text-align:center;float:left;width:40px;margin:3px 0px 0px 0px;height:15px;font-size:12px;">' + v + '%</div>'+			
			'</div>';
			return stml;
        }},
        {text: '状态', width: 120,dataIndex: 'status',renderer:function(v){
			...
			if(v==-1){
				...
				status =  "<div><img src='js/swfupload/icons/ok.png'/></div>";
			}else if(v==-5){
				status =  "停止上传";
			}		
			return status;
		}},
        {
            ...
            width:50,
            items: [{
                icon: 'js/swfupload/icons/delete.gif',
                tooltip: 'Remove',
                text:'删除',
