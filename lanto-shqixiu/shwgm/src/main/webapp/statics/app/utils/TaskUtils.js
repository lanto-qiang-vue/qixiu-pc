...
Ext.define('app.utils.TaskUtils', {
    ...
    task : {
     ...
     isLogin:function(){
     	...
     	if(loginTag == 'trans'){
     		userid = Ext.util.Cookies.get("trans_login_user_cookie_value");
    		usercode = Ext.util.Cookies.get("trans_login_userCode_cookie_value");
    		username = Ext.util.Cookies.get("trans_login_userName_cookie_value");
     	}else{
    ...
    renmoveLogin:function(){
    	if(loginTag == 'trans'){
			Ext.util.Cookies.clear("trans_login_user_cookie_value");
			Ext.util.Cookies.clear("trans_login_userCode_cookie_value");
			Ext.util.Cookies.clear("trans_login_userName_cookie_value");
		}else{
    ...
    appInfos:{
    	image:'statics/images/loginman.png',
    	title:'政府端',
    	requires:['app.store.AllRole',
				'app.store.CasecadeCode',
