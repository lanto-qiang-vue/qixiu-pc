Ext.define('app.model.employee.TbEmployeeExpertModel',{
	extend:'jsf.data.VO',
	fields:[
		...
		{name:'EMP_UNIT' , type:'string', label:'就职单位',query:'lk'},
		...
		{name:'HONOR' , type:'string', label:'主要荣誉'},
		{name:'GOOD_AT' , type:'string', label:'专业擅长',query:'lk'},
