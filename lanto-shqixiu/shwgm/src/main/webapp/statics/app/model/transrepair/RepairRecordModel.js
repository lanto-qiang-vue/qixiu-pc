Ext.define('app.model.transrepair.RepairRecordModel',{
	extend:'jsf.data.VO',
	fields:[
		{name:'RECORD_ID' , type:'int', label:'ID',isShowGrid:false},
		{name:'REPAIR_CORP_ID' , type:'int', label:'维修企业ID',isShowGrid:false,query:'eq'},
		{name:'TRANS_CORP_ID' , type:'int', label:'运输企业ID',isShowGrid:false,query:'eq'},
		{name:'REPAIR_CORP_NAME' , type:'string', label:'维修企业',isShowGrid:true},
		...
		{name:'REPAIR_TYPE' , type:'string', label:'维修类型',query: 'eq',isShowGrid:true,val:'dict|dict.1012'},
		{name:'ENGINE_NUMBER' , type:'string', label:'发动机号码',isShowGrid:true},
		{name:'CAR_VIN' , type:'string', label:'车架号',isShowGrid:true},
		{name:'REPAIR_DATE' , type:'date',dateFormat:'Y-m-d H:i:s',label:'送修时间',isShowGrid:true,query:'lk'},
