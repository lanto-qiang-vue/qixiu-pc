Ext.define('app.model.trans.VehicleBaseModel',{
	extend:'jsf.data.VO',
	fields:[
		...
		{name:'IS_SINGLE' , type:'string', label:'是否个体户',isShowGrid:false,val:'dict|dict.1004',query:'eq'},
		{name:'REPAIR_CYCLE' , type:'int', label:'维修周期',isShowGrid:false}
	]
});