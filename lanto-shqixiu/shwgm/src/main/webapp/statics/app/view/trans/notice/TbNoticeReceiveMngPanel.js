Ext.define('app.view.trans.notice.TbNoticeReceiveMngPanel',{
	extend:'Ext.panel.Panel',
	alias: 'widget.trans.notice.TbNoticeReceiveMngPanel',
	itemId: 'notice.trans.TbNoticeReceiveMngPanel',
	...
	getGridPanel : function(){
		return {
			...
			rowSelType : 'MULTI',
			model : 'app.model.notice.TbNoticeModel',
			url : 'trans/notice/tbnoticereceive/list',
			columns : [
