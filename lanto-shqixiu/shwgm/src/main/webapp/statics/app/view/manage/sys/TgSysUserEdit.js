Ext.define('app.view.manage.sys.TgSysUserEdit',{
	extend:'Ext.window.Window',
	alias: 'widget.manage.sys.TgSysUserEdit',
	itemId: 'manage.sys.TgSysUserEdit',
	title: '个人用户编辑',
	...
	loadData : function(record){
		...
		me.down('form').getForm().findField('TELPHONE').setReadOnly(true);
	},
