Ext.define('app.view.manage.vehicle.VehiclePlanMngPanel',{
	extend:'Ext.panel.Panel',
	alias: 'widget.manage.vehicle.VehiclePlanMngPanel',
	itemId: 'manage.vehicle.VehiclePlanMngPanel',
	...
	getGridPanel : function(){
		return {
			...
			rowSelType : 'MULTI',
			model : 'app.model.trans.VehiclePlanModel',
			url : 'manage/vehicle/vehicleplan/list',
			columns : [
