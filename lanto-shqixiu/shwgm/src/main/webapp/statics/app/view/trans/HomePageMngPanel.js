Ext.define('app.view.trans.HomePageMngPanel',{
	extend : 'Ext.form.Panel',
	alias : 'widget.trans.HomePageMngPanel',
	...
	loadData:function(type){
		var me = this;
		var url = 'trans/sys/common/getHomeInfo';
		var loding = me;
		if(type != 'all'){
...
//				if(type == '10171002' || type == 'all'){
//					var store2 = me.down('#repair2').getStore();
//					store2.removeAll();
//					store2.add(ret.data.repair2);
//				}
...
//				if(type == '10201002' || type == 'all'){
//					var st2 = me.down('#check2').getStore();
//					st2.removeAll();
//					st2.add(ret.data.check2);
//				}
			}
		});
	},
	toDetail:function(tag,plateNum){
		...
		var ctrlStr = 'app.controller.trans.vehicle.VehicleWarnCtrl';
		var itemStr = 'trans.vehicle.VehicleWarnMngPanel';
		var text = '车辆维护逾期报警';
		var iconStr = 'icon-shield';
		if(tag == 'plan'){
			ctrlStr = 'app.controller.trans.vehicle.VehiclePlanCtrl';
			itemStr = 'trans.vehicle.VehiclePlanMngPanel';
			text = '车辆维护计划';
			iconStr = 'icon-tags';
		}else if(tag == 'check'){
			ctrlStr = 'app.controller.trans.vehicle.VehicleCheckWarnCtrl';
			itemStr = 'trans.vehicle.VehicleCheckWarnMngPanel';
			text = '等级评定逾期报警';
			iconStr = 'icon-shield';
		}
