Ext.define('app.view.trans.notice.TbNoticeReceiveEdit',{
	extend:'Ext.window.Window',
	alias: 'widget.trans.notice.TbNoticeReceiveEdit',
	itemId: 'trans.notice.TbNoticeReceiveEdit',
	title: '查看通知',
...
//	modal : true,
	...
	loadData : function(record){
		...
		app.utils.AjaxCallbackUtil.ajaxLoadingCallback("trans/notice/tbnoticereceive/getContent",{NOTICE_ID:record.data.NOTICE_ID},me.down('panel'),function(ret){
			if( ret.success ){
	...
	loadHomePageData : function(id){
		var me = this;
		me.down('panel').setLoading("正在加载通知内容...");
		app.utils.AjaxCallbackUtil.ajaxLoadingCallback("trans/sys/homepage/getContent",{NOTICE_ID:id},me.down('panel'),function(ret){
			if( ret.success ){
