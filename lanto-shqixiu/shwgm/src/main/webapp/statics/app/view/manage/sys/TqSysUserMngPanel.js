Ext.define('app.view.manage.sys.TqSysUserMngPanel',{
	extend:'Ext.panel.Panel',
	alias: 'widget.manage.sys.TqSysUserMngPanel',
	itemId: 'manage.sys.TqSysUserMngPanel',
