Ext.define('app.view.trans.vehicle.VehicleWarnMngPanel',{
	extend:'Ext.panel.Panel',
	alias: 'widget.trans.vehicle.VehicleWarnMngPanel',
	itemId: 'trans.vehicle.VehicleWarnMngPanel',
	...
	getGridPanel : function(){
		return {
			...
			rowSelType : 'MULTI',
			model : 'app.model.trans.VehicleWarnModel',
			url : 'trans/vehicle/vehiclewarn/list',
			columns : [
