Ext.define('app.view.trans.notice.InfoPublicMngPanel',{
	extend:'Ext.panel.Panel',
	alias: 'widget.trans.notice.InfoPublicMngPanel',
	itemId: 'trans.notice.InfoPublicMngPanel',
	title: '行业信息预览',
	...
	getInfoPanel : function(){
		...
		var store = Ext.create('Ext.data.Store',{
			...
			proxy: {
		        ...
		        url: 'trans/notice/infopublic/list'
		    }
		});
		...
		return {
			...
			listeners:{
				itemclick:function(view,record){
					var win = Ext.create('app.view.trans.notice.TbInfoPublicView',{
