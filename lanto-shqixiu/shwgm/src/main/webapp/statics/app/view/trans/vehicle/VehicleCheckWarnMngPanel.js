Ext.define('app.view.trans.vehicle.VehicleCheckWarnMngPanel',{
	extend:'Ext.panel.Panel',
	alias: 'widget.trans.vehicle.VehicleCheckWarnMngPanel',
	itemId: 'trans.vehicle.VehicleCheckWarnMngPanel',
	...
	getGridPanel : function(){
		return {
			...
			rowSelType : 'MULTI',
			model : 'app.model.trans.VehicleCheckWarnModel',
			url : 'trans/vehicle/vehiclecheckwarn/list',
			columns : [
