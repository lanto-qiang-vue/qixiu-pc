Ext.define('app.view.manage.sys.TbSysRoleMngPanel',{
	extend:'Ext.panel.Panel',
	alias: 'widget.manage.sys.TbSysRoleMngPanel',
	itemId: 'manage.sys.TbSysRoleMngPanel',
