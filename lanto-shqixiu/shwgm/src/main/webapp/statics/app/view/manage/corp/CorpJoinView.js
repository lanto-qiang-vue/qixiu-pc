Ext.define('app.view.manage.corp.CorpJoinView',{
	extend:'Ext.window.Window',
	alias: 'widget.manage.corp.CorpJoinView',
	itemId: 'manage.corp.CorpJoinView',
	title: '入网资料查看',
	...
	loadData : function(record){
		...
		me.down("#map_position").update('<iframe height="100%" width="100%" src="manage/corp/corpjoin/position?isview=yes&joinId=' + record.get('JOIN_ID') + '" scrolling="yes" frameborder="0" id="corpjoinbmapFrame" name="bmapFrame"></iframe>');
