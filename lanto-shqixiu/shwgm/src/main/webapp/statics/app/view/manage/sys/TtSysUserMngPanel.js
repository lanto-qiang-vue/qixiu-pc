Ext.define('app.view.manage.sys.TtSysUserMngPanel',{
	extend:'Ext.panel.Panel',
	alias: 'widget.manage.sys.TtSysUserMngPanel',
	itemId: 'manage.sys.TtSysUserMngPanel',
