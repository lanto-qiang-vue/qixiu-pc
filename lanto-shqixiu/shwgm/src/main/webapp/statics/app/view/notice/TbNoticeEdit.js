Ext.define('app.view.notice.TbNoticeEdit',{
	extend:'Ext.window.Window',
	alias: 'widget.notice.TbNoticeEdit',
	itemId: 'notice.TbNoticeEdit',
	title: '发送通知',
				...
				items: [
			        ...
			        {xtype:'triggerfield',name:'CLIENT_ACTOR_DISPLAY',fieldLabel:'选择企业',
		                ...
		                onTriggerClick: function(e) {
			    			...
			    			var win = Ext.create("app.view.common.CorpMutSelWin",{
			    			     modal : true,
			    				 rowSelType : 'MULTI', //单选
	                ...
	                {xtype:'triggerfield',name:'MANAGE_ACTOR',fieldLabel:'政府端用户',
		                ...
		                onTriggerClick: function(e) {
		                	var me = this;
		                	var form = me.up('form').getForm();
			    			var win = Ext.create("app.view.common.UserSelWin",{
			    			     modal : true,
			    				 rowSelType : 'MULTI', //单选
				   				 callback:function( records ){
				   	    			//将取到的值赋给页面
