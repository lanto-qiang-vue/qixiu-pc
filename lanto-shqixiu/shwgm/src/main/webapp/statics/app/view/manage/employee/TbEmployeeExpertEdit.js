Ext.define('app.view.manage.employee.TbEmployeeExpertEdit',{
	extend:'Ext.window.Window',
	alias: 'widget.manage.employee.TbEmployeeExpertEdit',
	itemId: 'manage.employee.TbEmployeeExpertEdit',
	title: '从业人员基本信息',
			...
			items:[{
	            ...
	            items: [{
					...
					items: [
						...
						'NATIVE_PLACE',
						'SEX',
						{fname:'EMP_UNIT',colspan:2,width:480,readOnly:true},	
						'PROFESSOR',
						'DEGREE',
						{fname:'TELPHONE'},
						{fname:'ID_NUM',maxLength:18,colspan:3},
						{xtype:'textarea',anchor: '100%',height:80,fieldLabel:'主要荣誉',name:'HONOR',colspan:3,width:720},
						{xtype:'textarea',anchor: '100%',height:80,fieldLabel:'专业擅长',name:'GOOD_AT',colspan:3,width:720}	
					]
				}]
			}]
