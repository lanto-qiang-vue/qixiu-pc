Ext.define('app.view.manage.vehicle.VehiclePlanEdit',{
	extend:'Ext.window.Window',
	alias: 'widget.manage.vehicle.VehiclePlanEdit',
	itemId: 'manage.vehicle.VehiclePlanEdit',
	title: '添加维护计划',
	...
	initComponent : function() {
		...
		me.items = [{
			...
			url : 'manage/vehicle/vehicleplan/toPlanList',
			columns : [
