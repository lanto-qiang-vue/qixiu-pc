Ext.define('app.view.manage.vehicle.VehicleBaseView',{
	extend:'Ext.window.Window',
	alias: 'widget.manage.vehicle.VehicleBaseView',
	itemId: 'manage.vehicle.VehicleBaseView',
	title: '查看车辆档案',
	...
	part2:function(){
		...
		return {
            ...
            rowSelType : false,
            paging:false,
            model: 'app.model.RepairGeneManageModel',
            url: 'manage/vehicle/vehiclebase/repairList',
            columns: [		            
                {text:'序号',xtype:'rownumberer'},
                {fname:'LEAVE_DATE',text:'维修日期',width:100},
                {fname:'BILL_CODE',width:120,
                	...
                	listeners:{
                		click:function(a,b,c,d,e,f){
							...
							if(loginTag == 'trans'){
								url = 'trans/vehicle/vehiclebase/partList';
							}
							var params = {geneId : f.data.GENE_ID,billCode:f.data.BILL_CODE};
							var win = Ext.create('app.view.repair.RepairGeneManageEdit',{title:'查看维修记录',partUrl:url,picUrl:"manage/vehicle/vehiclebase/getPic"});
							win.loadViewData(f,params);
                		}
                	}
                },
                'REPAIR_TYPE',
                {fname:'REMARK',flex:1},
                {fname:'CORP_NAME',text:'维修企业'},
                'CREATED'
            ],
	            btns:[]	
		};
	...
	part3:function(){
		...
		return {
            ...
            url: 'manage/vehicle/vehiclebase/checkList',
            columns: [
                {text:'序号',xtype:'rownumberer'},
 ...
 part7: function(){
	...
	loadData : function(record){
		...
		repairstore.proxy.extraParams={vehId:record.get('VEHICLE_ID')};
		repairstore.load();
