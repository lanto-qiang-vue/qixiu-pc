Ext.define('app.view.manage.sys.TmSysUserEdit',{
	extend:'Ext.window.Window',
	alias: 'widget.manage.sys.TmSysUserEdit',
	itemId: 'manage.sys.TmSysUserEdit',
	title: '用户信息',
		...
		me.items = [ {
			...
			items:[{
				...
				items: [
					...
					{fname:'USER_CODE',vtype:'notEmpty',vtype:'alphanum'},
					{fname:'USER_NAME',vtype:'notEmpty'},
					'USER_SEX',
					'USER_TYPE',
					'TELPHONE',
					{	
