Ext.define('app.view.manage.sys.TpSysUserEdit',{
	extend:'Ext.window.Window',
	alias: 'widget.manage.sys.TpSysUserEdit',
	itemId: 'manage.sys.TpSysUserEdit',
	title: '专家用户编辑',
	...
	initComponent : function() {
		...
		me.items = [ {
			...
			items:[{
				...
				model : 'app.model.sys.TpSysUserModel',
				layout: {
            		type: 'table',
            		columns: 3
        		},
				...
				items: [
					...
					{fname:'USER_CODE'},
					{xtype:'triggerfield',name:'EXPERT_NAME',fieldLabel:'专家姓名',
		                ...
		                onTriggerClick: function(e) {
			    			...
			    			var win = Ext.create("app.view.common.ExpertSelWin",{
			    			     modal : true,
			    				 rowSelType : 'SINGLE', //单选
				   				 callback:function( records ){
				   	    			//将取到的值赋给页面
				   				 	var params = records[0].data;
				   				 	params.EXPERT_NAME = params.NAME;
