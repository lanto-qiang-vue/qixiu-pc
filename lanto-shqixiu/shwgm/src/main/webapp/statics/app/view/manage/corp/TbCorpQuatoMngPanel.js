Ext.define('app.view.manage.corp.TbCorpQuatoMngPanel',{
	extend:'Ext.window.Window',
	alias: 'widget.manage.corp.TbCorpQuatoMngPanel',
	itemId: 'manage.corp.TbCorpQuatoMngPanel',
...
//	autoScroll:true,
	...
	loadQuato : function(){
		var me = this;
		var params=me.down('form').getValues();
		var url = 'manage/corp/corpquato/getquato';
		app.utils.AjaxCallbackUtil.ajaxCallbackAll(url,{CORP_ID:params.CORP_ID},function(ret){
			if( ret.success ){
				...
				me.down('form').getForm().findField('UPLOAD_QUATO_COUNT').setValue(ret.data.uploadQuatoNum);
				me.down('form').getForm().findField('SEARCH_QUATO_COUNT').setValue(ret.data.searchQuatoNum);
			}
		});
	},
	getGridPanel : function(){
		return {
			...
			url : 'manage/corp/corpquato/list',
			columns : [
