Ext.define('app.view.trans.sys.TbCorpQuatoMngPanel',{
	extend:'Ext.panel.Panel',
	alias: 'widget.trans.sys.TbCorpQuatoMngPanel',
	itemId: 'trans.sys.TbCorpQuatoMngPanel',
