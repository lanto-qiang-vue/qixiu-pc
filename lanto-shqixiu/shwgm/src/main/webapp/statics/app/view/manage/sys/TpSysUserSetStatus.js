Ext.define('app.view.manage.sys.TpSysUserSetStatus',{
	extend:'Ext.window.Window',
	alias: 'widget.manage.sys.TpSysUserSetStatus',
	itemId: 'manage.sys.TpSysUserSetStatus',
	title: '专家用户编辑',
		...
		me.items = [ {
			...
			items:[{
				...
				items: [
					...
					{fname:'EXPERT_NAME',readOnly:true},
					{xtype:'container',
						width:160,
						rowspan:4,
						layout:'vbox',
