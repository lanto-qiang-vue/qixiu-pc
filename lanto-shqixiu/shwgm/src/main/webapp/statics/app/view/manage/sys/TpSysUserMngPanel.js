Ext.define('app.view.manage.sys.TpSysUserMngPanel',{
	extend:'Ext.panel.Panel',
	alias: 'widget.manage.sys.TpSysUserMngPanel',
	itemId: 'manage.sys.TpSysUserMngPanel',
