Ext.define('app.view.trans.vehicle.VehicleBaseMngPanel',{
	extend:'Ext.panel.Panel',
	alias: 'widget.trans.vehicle.VehicleBaseMngPanel',
	itemId: 'trans.vehicle.VehicleBaseMngPanel',
	...
	getGridPanel : function(){
		return {
			...
			rowSelType : 'MULTI',
			model : 'app.model.trans.VehicleBaseModel',
			url : 'trans/vehicle/vehiclebase/list',
			columns : [
			...
			btns : [{
				...
				text : '关联车辆',
				itemId : 'caseBtn',
				iconCls:'icon-link blue bigger-130',
				menu:{
					xtype:'uxmenu',
					plain: true,
					items:[{
