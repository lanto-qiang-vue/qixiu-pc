Ext.define('app.controller.trans.sys.TbSysRoleCtrl',{
	extend:'Ext.app.Controller',
	views: [
		'trans.sys.TbSysRoleMngPanel',
		'trans.sys.TbSysRoleEdit'],
	refs: [{
		ref : 'mngPanel',
		selector : 'panel[itemId=trans.sys.TbSysRoleMngPanel]'
	},{
		ref : 'searchPanel',
		selector : 'panel[itemId=trans.sys.TbSysRoleMngPanel] panel[itemId=spanel]'
	},{
		ref : 'gridPanel',
		selector : 'panel[itemId=trans.sys.TbSysRoleMngPanel] panel[itemId=gpanel]'
	}],
	init: function(ctrl) {
		this.control({
			'panel[itemId=trans.sys.TbSysRoleMngPanel]': {
                //afterrender : app.utils.CommonUtil.setPanelFuncPower
            },
            'panel[itemId=trans.sys.TbSysRoleEdit]': {
                //afterrender : app.utils.CommonUtil.setPanelFuncPower
            },
			'panel[itemId=trans.sys.TbSysRoleMngPanel] grid[itemId=gpanel]': {
				beforerender : this.initGridSearchCondition
			},
			'panel[itemId=trans.sys.TbSysRoleMngPanel] grid[itemId=gpanel] toolbar[dock=top] button':{
				click: this.gridBtnsHandler
			},
			'panel[itemId=trans.sys.TbSysRoleMngPanel] panel[itemId=spanel] button[itemId=searchBtn]':{
				click: this.doSearch
			},
	...
	doEdit:function(button){ 
		...
		var mds = ret.result;
		if(mds.data.CORP_ID == 'all_corp' && window.GL.userCode != 'ys'){
