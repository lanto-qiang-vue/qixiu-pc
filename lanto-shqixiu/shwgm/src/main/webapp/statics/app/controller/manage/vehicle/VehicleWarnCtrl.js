Ext.define('app.controller.manage.vehicle.VehicleWarnCtrl',{
	extend:'Ext.app.Controller',
	views: [
		'manage.vehicle.VehicleWarnMngPanel'],
	refs: [{
		ref : 'mngPanel',
		selector : 'panel[itemId=manage.vehicle.VehicleWarnMngPanel]'
	},{
		ref : 'searchPanel',
		selector : 'panel[itemId=manage.vehicle.VehicleWarnMngPanel] panel[itemId=spanel]'
	},{
		ref : 'gridPanel',
		selector : 'panel[itemId=manage.vehicle.VehicleWarnMngPanel] panel[itemId=gpanel]'
	}],
	init: function(ctrl) {
		this.control({
			'panel[itemId=manage.vehicle.VehicleWarnMngPanel]': {
		//		afterrender : app.utils.CommonUtil.setPanelFuncPower
			},
			'window[itemId=manage.vehicle.VehicleWarnEdit]': {
	//			afterrender : app.utils.CommonUtil.setPanelFuncPower
			},
			'panel[itemId=manage.vehicle.VehicleWarnMngPanel] grid[itemId=gpanel]': {
				beforerender : this.initGridSearchCondition
			},
			'panel[itemId=manage.vehicle.VehicleWarnMngPanel] panel[itemId=spanel] button[itemId=searchBtn]':{
				click: this.doSearch
			}
		});
	},
