Ext.define('app.controller.trans.vehicle.VehicleWarnCtrl',{
	extend:'Ext.app.Controller',
	views: [
		'trans.vehicle.VehicleWarnMngPanel'],
	refs: [{
		ref : 'mngPanel',
		selector : 'panel[itemId=trans.vehicle.VehicleWarnMngPanel]'
	},{
		ref : 'searchPanel',
		selector : 'panel[itemId=trans.vehicle.VehicleWarnMngPanel] panel[itemId=spanel]'
	},{
		ref : 'gridPanel',
		selector : 'panel[itemId=trans.vehicle.VehicleWarnMngPanel] panel[itemId=gpanel]'
	}],
	init: function(ctrl) {
		this.control({
			'panel[itemId=trans.vehicle.VehicleWarnMngPanel]': {
		//		afterrender : app.utils.CommonUtil.setPanelFuncPower
			},
			'window[itemId=trans.vehicle.VehicleWarnEdit]': {
	//			afterrender : app.utils.CommonUtil.setPanelFuncPower
			},
			'panel[itemId=trans.vehicle.VehicleWarnMngPanel] grid[itemId=gpanel]': {
				beforerender : this.initGridSearchCondition
			},
			'panel[itemId=trans.vehicle.VehicleWarnMngPanel] panel[itemId=spanel] button[itemId=searchBtn]':{
				click: this.doSearch
			}
		});
	},
