Ext.define('app.controller.manage.vehicle.VehicleCheckWarnCtrl',{
	extend:'Ext.app.Controller',
	views: [
		'manage.vehicle.VehicleCheckWarnMngPanel'],
	refs: [{
		ref : 'mngPanel',
		selector : 'panel[itemId=manage.vehicle.VehicleCheckWarnMngPanel]'
	},{
		ref : 'searchPanel',
		selector : 'panel[itemId=manage.vehicle.VehicleCheckWarnMngPanel] panel[itemId=spanel]'
	},{
		ref : 'gridPanel',
		selector : 'panel[itemId=manage.vehicle.VehicleCheckWarnMngPanel] panel[itemId=gpanel]'
	}],
	init: function(ctrl) {
		this.control({
			'panel[itemId=manage.vehicle.VehicleCheckWarnMngPanel]': {
		//		afterrender : app.utils.CommonUtil.setPanelFuncPower
			},
			'panel[itemId=manage.vehicle.VehicleCheckWarnMngPanel] grid[itemId=gpanel]': {
				beforerender : this.initGridSearchCondition
			},
			'panel[itemId=manage.vehicle.VehicleCheckWarnMngPanel] panel[itemId=spanel] button[itemId=searchBtn]':{
				click: this.doSearch
			}
		});
	},
