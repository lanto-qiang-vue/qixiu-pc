...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>上海市机动车排气污染维修企业检查记录表</title>
			...
			<div class="printMargins">
				<div class="pageContent">
					...
					<div style="width:100%;text-align:center;">
						<h2>上海市机动车排气污染维修企业检查记录表</h2>
					</div>
					<div style="width:100%;text-algin:center;">
						<table class="table" align="center" id="printTb">
							<tr class="h30">
								<th colspan="2" class="w100">企业名称</th>
								<td>${model.corpName }</td>
								<th class="w100">企业编号</th>
								<td colspan="2">${model.corpNum }</td>
							</tr>
							<tr class="h30">
								<th colspan="2" class="w100">经营地址</th>
								<td>${model.corpAdd }</td>
							...
							<tr class="h30">
								<th colspan="2" class="w100">检查内容</th>
								<th colspan="3">检查要求</th>
								<th class="w70">检查情况</th>
							</tr>
							<tbody>
							...
							<tr>
								...
								<td></td>
								<th class="w100">企业负责人签名(并盖单位公章)</th>
								<td colspan="2"></td>
							</tr>
						</table>
					</div>
