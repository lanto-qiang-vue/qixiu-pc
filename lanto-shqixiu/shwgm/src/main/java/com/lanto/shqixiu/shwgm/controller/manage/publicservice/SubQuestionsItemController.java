...
import com.lanto.shqixiu.shwgm.service.manage.publicservice.SubQuestionsItemService;
...
@Controller
@RequestMapping(value="manage/publicservice/subquestionsitem",produces = "text/html;charset=UTF-8")
public class SubQuestionsItemController extends BaseCon{

	private Logger logger = Logger.getLogger(SubQuestionsItemController.class);// 日志

	@Resource
	private SubQuestionsItemService service;
	...
	public Object save(HttpServletRequest request,HttpServletResponse response) {
		try{
			...
			TbSubQuestionsItem po = json.getPojo(data, TbSubQuestionsItem.class);
			ManageLoginInfo info = super.getManageLoginInfo();
