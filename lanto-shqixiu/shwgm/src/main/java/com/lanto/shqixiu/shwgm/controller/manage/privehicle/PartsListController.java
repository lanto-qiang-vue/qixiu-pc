...
import com.lanto.shqixiu.shwgm.service.manage.privehicle.PartsListService;
import com.lanto.shqixiu.shwgm.util.Constant;


@Controller
@RequestMapping(value="manage/privehicle/partslist",produces = "text/html;charset=UTF-8")
public class PartsListController extends BaseCon{

	private Logger logger = Logger.getLogger(PartsListController.class);// 日志
	...
	public Object save(HttpServletRequest request,HttpServletResponse response) {
		try{
			...
			TbRepairPartsList po = json.getPojo(data, TbRepairPartsList.class);
			ManageLoginInfo info = super.getManageLoginInfo();
