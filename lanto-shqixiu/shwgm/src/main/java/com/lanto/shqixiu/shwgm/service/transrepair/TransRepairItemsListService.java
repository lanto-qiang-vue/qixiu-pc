...
public class TransRepairItemsListService {
	...
	public Integer save(TbTransRepairItemsList pojo,ManageLoginInfo info) throws Exception{
	...
	public void update(TbTransRepairItemsList pojo,ManageLoginInfo info) throws SQLException{
