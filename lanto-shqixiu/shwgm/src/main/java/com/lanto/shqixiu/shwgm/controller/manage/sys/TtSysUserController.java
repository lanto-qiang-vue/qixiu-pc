...
@Controller(value="manageTtSysUserController")
@RequestMapping(value="manage/sys/ttsysuser",produces = "text/html;charset=UTF-8")
	...
	public Object save(HttpServletRequest request,HttpServletResponse response) {
		try{
			...
			if(po.getUserId() != null ){
				...
				TbTransCorpInfo corp = service.getCorpById(po.getCorpId());
