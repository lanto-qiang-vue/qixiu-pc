...
import com.lanto.shqixiu.shwgm.service.manage.privehicle.RepairRecordsService;



@Controller
@RequestMapping(value="manage/privehicle/repairrecords",produces = "text/html;charset=UTF-8")
