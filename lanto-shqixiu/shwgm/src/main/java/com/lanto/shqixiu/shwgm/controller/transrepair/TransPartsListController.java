...
import com.lanto.shqixiu.shwgm.model.po.TbTransRepairPartsList;
import com.lanto.shqixiu.shwgm.service.transrepair.TransPartsListService;
import com.lanto.shqixiu.shwgm.util.Constant;


@Controller
@RequestMapping(value="transrepair/partslist",produces = "text/html;charset=UTF-8")
public class TransPartsListController extends BaseCon{

	private Logger logger = Logger.getLogger(TransPartsListController.class);// 日志

	@Resource
	private TransPartsListService service;
	...
	public Object save(HttpServletRequest request,HttpServletResponse response) {
		try{
			...
			TbTransRepairPartsList po = json.getPojo(data, TbTransRepairPartsList.class);
			ManageLoginInfo info = super.getManageLoginInfo();
