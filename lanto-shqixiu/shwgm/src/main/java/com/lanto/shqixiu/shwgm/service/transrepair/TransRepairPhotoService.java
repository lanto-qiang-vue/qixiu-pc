...
import com.lanto.shqixiu.shwgm.model.po.TbTransRepairPhoto;
...
public class TransRepairPhotoService {
	...
	public String save(TbTransRepairPhoto pojo,ManageLoginInfo info) throws Exception{
	...
	public void update(TbTransRepairPhoto pojo,ManageLoginInfo info) throws SQLException{
