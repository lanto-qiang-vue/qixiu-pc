...
import com.lanto.shqixiu.shwgm.service.manage.exahrepair.ExhaRepairRecordsService;


@Controller
@RequestMapping(value="manage/exharepair/repairrecords",produces = "text/html;charset=UTF-8")
