...
public class TransPartsListService {
	...
	public Integer save(TbTransRepairPartsList pojo,ManageLoginInfo info) throws Exception{
	...
	public void update(TbTransRepairPartsList pojo,ManageLoginInfo info) throws SQLException{
