...
@Controller
@RequestMapping(value="trans/notice/infopublic",produces = "text/html;charset=UTF-8")
public class InfoPublicTransController extends BaseCon{

	private Logger logger = Logger.getLogger(InfoPublicTransController.class);// 日志
