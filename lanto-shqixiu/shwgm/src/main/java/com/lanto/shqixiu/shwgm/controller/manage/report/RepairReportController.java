...
import com.lanto.shqixiu.shwgm.service.manage.report.RepairReportService;


@Controller
@RequestMapping(value="manage/report/repairreport",produces = "text/html;charset=UTF-8")
