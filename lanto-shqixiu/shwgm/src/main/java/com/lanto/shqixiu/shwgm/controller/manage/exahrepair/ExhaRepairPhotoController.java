...
import com.lanto.shqixiu.shwgm.service.manage.exahrepair.ExhaRepairPhotoService;
import com.lanto.shqixiu.shwgm.util.Constant;


@Controller
@RequestMapping(value="manage/exharepair/repairphoto",produces = "text/html;charset=UTF-8")
