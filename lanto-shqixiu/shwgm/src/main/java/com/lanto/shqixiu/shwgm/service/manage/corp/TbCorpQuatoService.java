...
public class TbCorpQuatoService {
	...
	public String save(TbRepairQuato pojo,ManageLoginInfo info) throws Exception{
	...
	public void update(TbRepairQuato pojo,ManageLoginInfo info) throws SQLException{
