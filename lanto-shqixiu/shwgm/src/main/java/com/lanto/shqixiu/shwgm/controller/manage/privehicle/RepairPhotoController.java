...
import com.lanto.shqixiu.shwgm.service.manage.privehicle.RepairPhotoService;
import com.lanto.shqixiu.shwgm.util.Constant;


@Controller
@RequestMapping(value="manage/privehicle/repairphoto",produces = "text/html;charset=UTF-8")
public class RepairPhotoController extends BaseCon{

	private Logger logger = Logger.getLogger(RepairPhotoController.class);// 日志

	@Resource
	private RepairPhotoService service;
	...
	public Object save(HttpServletRequest request,HttpServletResponse response) {
		try{
			...
			TbRepairPhoto po = json.getPojo(data, TbRepairPhoto.class);
			ManageLoginInfo info = super.getManageLoginInfo();
