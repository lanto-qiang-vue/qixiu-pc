...
import com.lanto.shqixiu.shwgm.model.po.TbExhaustRepairItemsList;
import com.lanto.shqixiu.shwgm.service.manage.exahrepair.ExhaRepairItemsListService;


@Controller
@RequestMapping(value="manage/exharepair/repairitemslist",produces = "text/html;charset=UTF-8")
public class ExhaRepairItemsListController extends BaseCon{

	private Logger logger = Logger.getLogger(ExhaRepairItemsListController.class);// 日志

	@Resource
	private ExhaRepairItemsListService service;
	...
	public Object save(HttpServletRequest request,HttpServletResponse response) {
		try{
			...
			TbExhaustRepairItemsList po = json.getPojo(data, TbExhaustRepairItemsList.class);
			ManageLoginInfo info = super.getManageLoginInfo();
