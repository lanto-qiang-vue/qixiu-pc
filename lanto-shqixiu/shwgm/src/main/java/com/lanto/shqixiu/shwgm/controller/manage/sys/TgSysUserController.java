...
import com.lanto.shqixiu.shwgm.service.manage.sys.TgSysUserService;
import com.lanto.shqixiu.shwgm.service.notice.InfoPublicService;
import com.lanto.shqixiu.shwgm.util.Constant;


@Controller
@RequestMapping(value="manage/sys/tgsysuser",produces = "text/html;charset=UTF-8")
public class TgSysUserController extends BaseCon{

	private Logger logger = Logger.getLogger(TgSysUserController.class);// 日志

	@Resource
	private TgSysUserService service;
	...
	public Object save(HttpServletRequest request,HttpServletResponse response) {
		try{
			...
			TgSysUser po = json.getPojo(data, TgSysUser.class);
			ManageLoginInfo info = super.getManageLoginInfo();
