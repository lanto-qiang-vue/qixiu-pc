...
import com.lanto.shqixiu.shwgm.service.manage.sys.TjSysUserService;
import com.lanto.shqixiu.shwgm.service.manage.sys.TtSysUserService;
import com.lanto.shqixiu.shwgm.util.MD5;


@Controller(value="manageTjSysUserController")
@RequestMapping(value="manage/sys/tjsysuser",produces = "text/html;charset=UTF-8")
	...
	public Object save(HttpServletRequest request,HttpServletResponse response) {
		try{
			...
			if(po.getUserId() != null ){
				...
				TbCorpDetectInfo corp = service.getCorpById(po.getCorpId());
				po.setBlongArea(corp.getStationArea());
				po.setRoleId(1);
				service.save(po);
			}
