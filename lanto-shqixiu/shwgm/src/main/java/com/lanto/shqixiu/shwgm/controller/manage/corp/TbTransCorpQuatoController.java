...
@Controller
@RequestMapping(value="manage/corp/transcorpquato",produces = "text/html;charset=UTF-8")
public class TbTransCorpQuatoController extends BaseCon{

	private Logger logger = Logger.getLogger(TbTransCorpQuatoController.class);// 日志
	...
	public Object save(HttpServletRequest request,HttpServletResponse response) {
		try{
			...
			TbTransQuato po = json.getPojo(data, TbTransQuato.class);
	...
	public Object getQuato(HttpServletRequest request,HttpServletResponse response) {
		try {
			...
			TbTransCorpInfo corp = corpService.getModel(corpId);
