...
public class MHandlerInterceptor extends HandlerInterceptorAdapter {
	...
	private Logger logger = Logger.getLogger(MHandlerInterceptor.class);// 日志
...
//			}
	...
	public String getLoginUserId(HttpServletRequest request) throws UnsupportedEncodingException{
		return CommonUtils.checkNull(getCookieValue(Constant.MANAGE_LOGIN_USER_COOKIE_VALUE,request));
	}
	
	public String getLoginUserCode(HttpServletRequest request) throws UnsupportedEncodingException{
		return CommonUtils.checkNull(getCookieValue(Constant.MANAGE_LOGIN_USERCODE_COOKIE_VALUE,request));
	}
