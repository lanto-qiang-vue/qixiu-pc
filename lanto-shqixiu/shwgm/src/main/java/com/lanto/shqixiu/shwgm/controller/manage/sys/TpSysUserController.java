...
import com.lanto.shqixiu.shwgm.service.manage.sys.TpSysUserService;
import com.lanto.shqixiu.shwgm.util.Constant;


@Controller
@RequestMapping(value="manage/sys/tpsysuser",produces = "text/html;charset=UTF-8")
public class TpSysUserController extends BaseCon{

	private Logger logger = Logger.getLogger(TpSysUserController.class);// 日志

	@Resource
	private TpSysUserService service;
	...
	public Object save(HttpServletRequest request,HttpServletResponse response) {
		try{
			...
			TpSysUser po = json.getPojo(data, TpSysUser.class);
			ManageLoginInfo info = super.getManageLoginInfo();
			if(CommonUtils.checkIsNotNullAndZero(po.getUserId())){
