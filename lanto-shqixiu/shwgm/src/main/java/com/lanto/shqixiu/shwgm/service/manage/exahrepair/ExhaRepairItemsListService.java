...
public class ExhaRepairItemsListService {
	...
	public Integer save(TbExhaustRepairItemsList pojo,ManageLoginInfo info) throws Exception{
	...
	public void update(TbExhaustRepairItemsList pojo,ManageLoginInfo info) throws SQLException{
