...
import com.lanto.shqixiu.shwgm.model.po.TbExhaustRepairPhoto;
...
public class ExhaRepairPhotoService {
	...
	public String save(TbExhaustRepairPhoto pojo,ManageLoginInfo info) throws Exception{
	...
	public void update(TbExhaustRepairPhoto pojo,ManageLoginInfo info) throws SQLException{
