...
//	public static final String REPAIR_PHOTO_PIC_URL = "http://219.137.166.188/JrFileSystemServer2/servlet/FileSystemServlet?fileId=";
	...
	//附件上传保存项目名称
	public static final String ATTACH_FILE_UPLOAD_PROJECT = "shwgm/";
	
	public static final String XPDF_PATH = "D:\\xpdf";
	
	
	//打印REPORTID
	public static final String REPORT_ID_CORP_INFO_ZB = "4401000010001";//道路运输许可证正本
	public static final String REPORT_ID_CORP_INFO_FB = "4401000030001";//道路运输许可证副本
	public static final String REPORT_ID_GENE_REPAIR = 	"4401000020001";//普通维修
	public static final String REPORT_ID_SLM_RECORD = 	"4401000040001";//二级维护备案
	public static final String REPORT_ID_EMPLOYEE_RECORD = 	"4401000050001";//从业人员资格证	
	public static final String REPORT_ID_REPAIR_VEHICLE = "4310000030002";	//车辆健康档案	
	// 状态
	...
	public static final String QUALIFICATION_OPE_OBJECT_10 = "10191010";//竣工检验资质	
	//业务办理状态
