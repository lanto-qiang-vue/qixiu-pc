...
import com.lanto.shqixiu.shwgm.service.manage.sys.SysHelpService;


@Controller
@RequestMapping(value = "manage/sys/help",produces = "text/html;charset=UTF-8")
public class SysHelpController extends BaseCon{
	...
	public Object save(HttpServletRequest request,HttpServletResponse response) {
		try{
			...
			TmSysHelp po = json.getPojo(data, TmSysHelp.class);
			TmSysHelp con = new TmSysHelp();
