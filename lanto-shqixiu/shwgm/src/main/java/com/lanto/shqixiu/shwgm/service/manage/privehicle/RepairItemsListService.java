...
public class RepairItemsListService {
	...
	public Integer save(TbRepairItemsList pojo,ManageLoginInfo info) throws Exception{
	...
	public void update(TbRepairItemsList pojo,ManageLoginInfo info) throws SQLException{
