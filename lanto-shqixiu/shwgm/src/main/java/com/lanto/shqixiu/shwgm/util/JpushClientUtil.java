...
public class JpushClientUtil {
    ...
    private final static String appKey = "3894a1c15219034da3ad2e41";
    private final static String masterSecret = "25152900a5606f3d20ddbfde";
        ...
        return PushPayload.newBuilder()
                ...
                .setNotification(Notification.newBuilder()
                        ...
                        .addPlatformNotification(AndroidNotification.newBuilder()
                                ...
                                .addExtra("type",1001)
                                .addExtra("reference_id", extrasparam)
                                .build()
                        )
