...
public class Constant {
	...
	public static final String WEBSITE_REMBER_LOGIN_7DAY = "c_r_l_7d";
	public static final String WEBSITE_REMBER_LOGIN = "c_r_l_u";

	// 附件上传保存目录
	// public static final String ATTACH_FILE_UPLOAD_PATH =
	// "D:\\fileUpload\\attach\\";
	// public static final String ATTACH_FILE_UPLOAD_PATH =
	// "\\\\10.194.102.7\\fileShare\\fileUpload\\attach\\";

	// 员工照片保存目录
	// public static final String PHOTO_FILE_UPLOAD_PATH =
	// "D:\\fileUpload\\photo\\";
	// public static final String PHOTO_FILE_UPLOAD_PATH =
	// "\\\\10.194.102.7\\fileShare\\fileUpload\\photo\\";
	// 获取维修记录图片地址
