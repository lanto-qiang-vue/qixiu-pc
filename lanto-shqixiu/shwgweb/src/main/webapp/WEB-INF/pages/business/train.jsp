...
<div class="supervision">
	...
	<div class="examine" style="height: 628px;">
		<ul class="zhengwu_c" id="databody">
			<li><a href="${ctx}/business/train1">上海交运汽车修理职业技能培训中心简介</a><span></span></li>
			<li><a href="${ctx}/business/train2">上海市交通学校简介</a><span></span></li>
			<li><a href="${ctx}/business/train3">上海公用职业技术培训学校简介</a><span></span></li>
		</ul>
