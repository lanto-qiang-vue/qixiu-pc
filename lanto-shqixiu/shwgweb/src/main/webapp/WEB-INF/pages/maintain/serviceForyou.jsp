        ...
        <form class="layui-form" style="margin-top: 10px"> <!-- 提示：如果你不想用form，你可以换成div等任何一个普通元素 -->
            <div class="layui-form-item">
                ...
                <div class="layui-input-block" style="width: 500px">
                    <input type="text" name="ownerName" placeholder="请输入" id="ownerName" autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block" style="width: 500px">
                    <input type="number" name="contactMobile" placeholder="请输入" id="contactMobile" autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block" style="width: 500px">
                    <input type="text" name="content" placeholder="请输入" id="content" autocomplete="off" class="layui-input">
                </div>
            </div>
    ...
    layui.use('form', function(){
        ...
        form.on('submit(serviceSubmit)', function(data){
            ...
            var param={
                ...
                contact_name: data.field.ownerName,
                contact_tel: data.field.contactMobile,
                content: data.field.content,
            }
            accessPost(baseu+ '/maintain/addOnserviceForyou', JSON.stringify(param), function (res) {
                console.log('res: ', res);
