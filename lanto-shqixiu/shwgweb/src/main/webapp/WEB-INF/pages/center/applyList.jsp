...
<body>
	...
	<div class="Government archives">
		...
		<div class="zhengwu_r">
			<div class="zhengwu_t">
				<span class="sp_zw">爱车档案</span> <span class="sp_wz">您所在位置：<a
					href="${ctx}/center/userInfo">车主中心</a> > <span>爱车档案</span></span>
			</div>
			<div class="biaoge">
...
//            window.location.href='recordDetail?id='+$(this).attr('id')
    ...
    function search(carcard, limit, page, laypage) {
        ...
        accessPost(baseu+ '/vehicle/owner/queryVehicelist', JSON.stringify(param), function (res) {
