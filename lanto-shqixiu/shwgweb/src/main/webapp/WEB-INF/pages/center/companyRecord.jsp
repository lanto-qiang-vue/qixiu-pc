...
<div class="Government archives">
	...
	<div class="zhengwu_r">
		...
		<form class="layui-form" >
			...
			<div id="back" class="layui-btn layui-btn-normal" lay-submit lay-filter="formDemo" style="margin-left: 60px">后退</div>
		</form>
...
//            console.log(this)
        ...
        $("#search").click(function () {
            ...
            search($("#carcard").val(),vinParam,$("#companyname").val(), 10, 1, laypage)
        })
    ...
    function search(carcard,vin,companyname,limit, page, laypage) {
        ...
        accessPost(baseu+ '/vehicle/carfile/query4manager', JSON.stringify(param), function (res) {
            ...
            for (var i in data){
                html+='<tr id="'+data[i].repairbasicinfoId+'"><td>'+(parseInt((param.pageNo - 1) * param.pageSize + parseInt(i) + 1))+'</td> <td>'+data[i].vehicleplatenumber+'</td> <td>'+data[i].vin+'</td> <td>'+data[i].repairdate+'</td> <td>'+data[i].costlistcode+'</td><td>'+data[i].companyname+'</td></tr>'
            }
