...
import com.lanto.shqixiu.shcheck.service.check.CheckPhotoService;
import com.lanto.shqixiu.shcheck.service.transrepair.TransRepairPhotoService;
...
public class CheckPhotoController extends BaseCon{
	...
	public Object save(HttpServletRequest request,HttpServletResponse response) {
		try{
			...
			TbCheckPhoto po = json.getPojo(data, TbCheckPhoto.class);
			CheckLoginInfo info = super.getCheckLoginInfo();
