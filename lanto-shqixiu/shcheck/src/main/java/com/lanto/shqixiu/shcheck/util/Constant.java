...
public class Constant {
	...
	//检测站端
	public static final String CHECK_LOGIN_USER_COOKIE_VALUE = "check_login_user_cookie_value";   //userId
	public static final String CHECK_LOGIN_USERCODE_COOKIE_VALUE = "check_login_userCode_cookie_value";   //userCode
	public final static String CHECK_LOGIN_USERNAME_COOKIE_VALUE = "check_login_userName_cookie_value";   //userName
	public static final String CHECK_LOGIN_CORPID_COOKIE_VALUE = "check_login_corpid_cookie_value";   //corpId
	public static final String CHECK_LOGIN_CORPNAME_COOKIE_VALUE = "check_login_corpname_cookie_value";   //corpName
	public final static String CHECK_LOGIN_AREA_COOKIE_VALUE = "check_login_area_cookie_value";   //area
...
//	public static final String PHOTO_FILE_UPLOAD_PATH = "\\\\10.194.102.7\\fileShare\\fileUpload\\photo\\";
	...
	//附件上传保存项目名称
	public static final String ATTACH_FILE_UPLOAD_PROJECT= "shwgweb/";
