...
public class TransRepairItemsListService {
	...
	public Integer save(TbTransRepairItemsList pojo,CheckLoginInfo info) throws Exception{
	...
	public void update(TbTransRepairItemsList pojo,CheckLoginInfo info) throws SQLException{
