...
public class TransRepairRecordsService {
	...
	public Integer save(TbTransRepairRecords pojo,CheckLoginInfo info) throws Exception{
	...
	public void update(TbTransRepairRecords pojo,CheckLoginInfo info) throws SQLException{
