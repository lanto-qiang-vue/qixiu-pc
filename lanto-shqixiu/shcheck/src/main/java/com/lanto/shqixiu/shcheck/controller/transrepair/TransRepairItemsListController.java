...
import com.lanto.shqixiu.shcheck.model.po.TbTransRepairItemsList;
import com.lanto.shqixiu.shcheck.service.transrepair.TransRepairItemsListService;


@Controller
@RequestMapping(value="transrepair/repairitemslist",produces = "text/html;charset=UTF-8")
public class TransRepairItemsListController extends BaseCon{

	private Logger logger = Logger.getLogger(TransRepairItemsListController.class);// 日志

	@Resource
	private TransRepairItemsListService service;
	...
	public Object save(HttpServletRequest request,HttpServletResponse response) {
		try{
			...
			TbTransRepairItemsList po = json.getPojo(data, TbTransRepairItemsList.class);
			CheckLoginInfo info = super.getCheckLoginInfo();
