...
import com.lanto.shqixiu.shcheck.model.po.TqSysHelp;
import com.lanto.shqixiu.shcheck.service.SysHelpService;


@Controller
@RequestMapping(value = "check/sys/help",produces = "text/html;charset=UTF-8")
