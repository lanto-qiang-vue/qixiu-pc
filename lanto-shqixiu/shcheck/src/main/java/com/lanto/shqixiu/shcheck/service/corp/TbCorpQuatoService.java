...
public class TbCorpQuatoService {
	...
	public String save(TbRepairQuato pojo,CheckLoginInfo info) throws Exception{
	...
	public void update(TbRepairQuato pojo,CheckLoginInfo info) throws SQLException{
