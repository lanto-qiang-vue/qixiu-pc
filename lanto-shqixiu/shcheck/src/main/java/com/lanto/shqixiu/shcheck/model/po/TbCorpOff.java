...
public class TbCorpOff implements Serializable {
	private Integer offId;	//ID
	...
	private String acceptOpinion;	//ACCEPT_OPINION
	private String acceptOper;	//ACCEPT_OPER
	private Date acceptDate;	//ACCEPT_DATE
