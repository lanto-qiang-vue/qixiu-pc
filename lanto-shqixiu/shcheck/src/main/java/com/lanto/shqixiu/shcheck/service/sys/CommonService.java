...
public class CommonService {
	...
	public List<TcFunc> getMenus(Integer userId){
		...
		sql.append("  FROM TJ_SYS_ROLE_FUNC RF\n" );
		sql.append("  LEFT JOIN TJ_FUNC F ON RF.FUNC_ID = F.FUNC_ID\n" );
		sql.append(" WHERE RF.ROLE_ID IN (SELECT ROLE_ID FROM TJ_SYS_USER WHERE USER_ID = ?) ORDER BY F.SORT_ORDER");
