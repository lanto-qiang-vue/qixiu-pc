		...
		<div class="page_autoH A4_Vertical_autoH">
			<div class="printMargins">
				<div class="pageContent">
					...
					<div style="width:100%;text-align:center;margin-bottom:20px;font-size:29px;font-family : 仿宋_GB2312;margin-top:10px;line-height:40px;">
						上海市机动车维修与驾驶员培训行业管理处<br/>日常监督检查记录表
					</div>
					...
					<div style="font-size:13px;">
						...
						<div style="width:49%;float:left;border-bottom: 1px dashed #000;line-height:35px;height:35px;padding-top:2px;font-family : 仿宋_GB2312;">检查人员签名：</div>
					</div>
					...
					<div style="font-size:13px;padding-left:10px;border-bottom: 1px dashed #000;line-height:35px;font-family : 仿宋_GB2312;">
						报 <span style="font-size:13px;border-bottom: 1px solid #000;line-height:35px;font-family : 仿宋_GB2312;">${model.applyTo }</span>
					</div>
					<div style="font-size:13px;">
						...
						<div style="width:47%;float:right;border-bottom: 1px dashed #000;line-height:35px;text-align:right;padding-right:10px;font-family : 仿宋_GB2312;">年 <span style="width:40px;display:-moz-inline-box;display:inline-block;"></span>月 <span style="width:40px;display:-moz-inline-box;display:inline-block;"></span>日</div>
					</div>
					<div style="text-align:center;border-top: 1px solid #000;margin-top:100px;"></div>
					<div style="text-align:center;border-top: 4px solid #000;margin-top:2px;font-family : 仿宋_GB2312;"></div>
