Ext.define('app.controller.sys.ChangePassCtrl', {
	extend: 'Ext.app.Controller',
	views: ['sys.ChangePassMngPanel'],
	init: function(dms) {
		this.control({
			'panel[itemId=sys.ChangePassMngPanel]': {
	            afterrender : app.utils.CommonUtil.setPanelFuncPower
	        },
			'panel[itemId=sys.ChangePassMngPanel] button[itemId=saveBtn]': {
	            click : this.doSave
	        }
		});
	},
