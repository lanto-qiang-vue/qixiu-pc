Ext.define('app.utils.vtype.CommonVtype', {
    ...
    LicenseText: '该输入项必须是车牌号，格式：“粤A88888”' ,
    /**邮政编码**/
    ZipCode : function(v){
    ...
    plateNumLeft:  function(v) {
        return /^[A-Z_0-9]{4}[A-Z_0-9_学_警]{1}$/.test(v);
    },
    plateNumLeftText: '请输入正确的车牌号码，格式如： "粤A.XXXXX"',
    plateNumLeftMask: /[0-9_A-Z_a-z_学_警]/i
});