Ext.define('app.view.transrepair.SendSms',{
	extend:'Ext.window.Window',
	alias: 'widget.transrepair.SendSms',
	itemId: 'transrepair.SendSms',
...
//	autoScroll:true,
			...
			items : ['->',
					{
						...
						disabled:true,
						handler : function(btn){
							var win =	Ext.create('app.view.transrepair.TransVehicleFile',{title:'<i class="' + btn.iconCls + '"></i> 维修记录查看'});
							win.show();
	...
	loadData : function(record){
		var me = this;
		if(record.data.OWNER_PHONE==""){
			record.data.OWNER_PHONE=record.data.CORP_PHONE;
		}
