...
import com.lanto.shqixiu.shwgc.model.bean.FuncCheckedNode;
import com.lanto.shqixiu.shwgc.model.bean.TcCheckFunc;
import com.lanto.shqixiu.shwgc.model.po.TqSysRole;
import com.lanto.shqixiu.shwgc.service.sys.TbSysRoleService;


@Controller
@RequestMapping(value="client/sys/tbsysrole",produces = "text/html;charset=UTF-8")
public class SysRoleController extends BaseCon{
	...
	public Object save(HttpServletRequest request,HttpServletResponse response) {
		try{
			...
			TqSysRole po = json.getPojo(data, TqSysRole.class);
	...
	*/
	...
	private void createWhere(List<SqlUnit> sList,HttpServletRequest request){
		...
		sList.add(new SqlUnit("CORP_ID", " and CORP_ID in (?,?) ", super.getClientLoginInfo().getCorpId()));
