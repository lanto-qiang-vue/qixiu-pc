...
import com.lanto.shqixiu.shwgc.service.notice.TbNoticeReceiveService;
import com.lanto.shqixiu.shwgc.util.Constant;


@Controller
@RequestMapping(value="client/notice/tbnoticereceive",produces = "text/html;charset=UTF-8")
