...
import com.lanto.shqixiu.shwgc.service.sys.TqSysUserService;
import com.lanto.shqixiu.shwgc.util.MD5;


@Controller
@RequestMapping(value="client/sys/tqsysuser",produces = "text/html;charset=UTF-8")
public class TqSysUserController extends BaseCon{
	...
	public Object save(HttpServletRequest request,HttpServletResponse response) {
		try{
			...
			if(po.getUserId() != null ){
				...
				po.setCorpId(super.getClientLoginInfo().getCorpId());
				po.setBlongArea(super.getClientLoginInfo().getAreaCode());
	...
	private void createWhere(List<SqlUnit> sList,HttpServletRequest request){
		...
		sList.add(new SqlUnit("CORP_ID", " and CORP_ID = ? ", super.getClientLoginInfo().getCorpId()));
