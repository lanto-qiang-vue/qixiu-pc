...
import com.lanto.shqixiu.shwgc.model.bean.TcFileUploadInfoBean;
...
public class FileUploadService {
	...
	public Map save(HttpServletRequest request) throws IllegalStateException, IOException{
		...
		fileBillId = CommonUtils.checkIsNullStr(fileBillId) ? "-1"
				: fileBillId;
	...
	public boolean isHaveUpload(String billId,String billType){
		String sql = "SELECT * FROM TC_FILE_UPLOAD_INFO WHERE BILL_TYPE=? AND BILL_ID=?";
		List list = service.findAll(sql, billType,billId);
