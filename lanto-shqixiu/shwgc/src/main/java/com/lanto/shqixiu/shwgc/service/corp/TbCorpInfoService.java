...
import com.lanto.shqixiu.shwgc.model.po.TbExamHis;
...
public class TbCorpInfoService {
	...
	public void update(TbCorpInfo pojo,List<TbExamHis> exams,ClientLoginInfo login){
	...
	//建档配额减1
	public boolean createQuatoMinus1(String corpId,String plateNum,ClientLoginInfo login){
	...
	//维修记录配额减1
	public boolean uploadQuatoMinus1(String corpId,String plateNum,ClientLoginInfo login){
		TbCorpInfo corp=getModel(corpId);
	...
	//查询配额减1
	public boolean searchQuatoMinus1(String corpId,String plateNum,ClientLoginInfo login){
		TbCorpInfo corp=getModel(corpId);
	...
	public void updateQuato(TbRepairQuato pojo,ClientLoginInfo login){
