...
import com.lanto.shqixiu.shwgc.model.po.TbNoticeResult;
import com.lanto.shqixiu.shwgc.model.po.TbNoticeSee;
...
public class TbNoticeReceiveService {
	...
	public List getList(List<SqlUnit> uSql, PageUnit page) throws SQLException{
		...
		String sql = "(SELECT A.*," +
				...
				"B.SEE_DATE " + 
				" FROM V_NOTICE A LEFT JOIN (SELECT * FROM TB_NOTICE_SEE WHERE ACTOR_ID=? and corp_type='10491001') B ON A.NOTICE_ID = B.NOTICE_ID) T";
