...
import com.lanto.shqixiu.shwgc.service.repair.RepairItemsService;


@Controller
@RequestMapping(value="repair/repairitems",produces = "text/html;charset=UTF-8")
public class RepairItemsController extends BaseCon{

	private Logger logger = Logger.getLogger(RepairItemsController.class);// 日志

	@Resource
	private RepairItemsService service;
	...
	public Object save(HttpServletRequest request,HttpServletResponse response) {
		try{
			...
			TbRepairItems po = json.getPojo(data, TbRepairItems.class);
			ClientLoginInfo info = super.getClientLoginInfo();
