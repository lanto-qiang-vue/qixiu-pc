...
@Controller
@RequestMapping(value="service/onsiteservice",produces = "text/html;charset=UTF-8")
public class OnSiteServiceController extends BaseCon{

	private Logger logger = Logger.getLogger(OnSiteServiceController.class);// 日志

	@Resource
	private OnSiteServiceService service;
	...
	public Object save(HttpServletRequest request,HttpServletResponse response) {
		try{
			...
			TbOnSiteService po = json.getPojo(data, TbOnSiteService.class);
			ClientLoginInfo info = super.getClientLoginInfo();
