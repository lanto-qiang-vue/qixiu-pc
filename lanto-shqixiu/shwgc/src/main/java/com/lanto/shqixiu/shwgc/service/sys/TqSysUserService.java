...
public class TqSysUserService {
	...
	public List getList(List<SqlUnit> uSql, PageUnit page) throws SQLException{
		...
		return service.getPageList(uSql, page, "(SELECT A.*,B.ROLE_NAME FROM TQ_SYS_USER A LEFT JOIN TQ_SYS_ROLE B ON A.ROLE_ID=B.ROLE_ID) T","USER_ID");
	}

	public Integer save(TqSysUser pojo,ClientLoginInfo info) throws Exception{
	...
	public void update(TqSysUser pojo,ClientLoginInfo info){
