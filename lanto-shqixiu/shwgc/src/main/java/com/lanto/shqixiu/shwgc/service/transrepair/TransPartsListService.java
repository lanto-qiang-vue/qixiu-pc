...
public class TransPartsListService {
	...
	public Integer save(TbTransRepairPartsList pojo,ClientLoginInfo info) throws Exception{
	...
	public void update(TbTransRepairPartsList pojo,ClientLoginInfo info) throws SQLException{
