...
import com.lanto.shqixiu.shwgc.service.corp.TbCorpQuatoService;


@Controller
@RequestMapping(value="sys/corpquato",produces = "text/html;charset=UTF-8")
public class TbRepairQuatoController extends BaseCon{
	...
	public Object getQuato(HttpServletRequest request,HttpServletResponse response) {
		try {
			...
			TbCorpInfo corp = corpService.getModel(info.getCorpId());
