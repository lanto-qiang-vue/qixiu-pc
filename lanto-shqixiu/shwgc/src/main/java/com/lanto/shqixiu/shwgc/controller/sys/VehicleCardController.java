...
import com.lanto.shqixiu.shwgc.service.sys.VehicleCardService;
import com.lanto.shqixiu.shwgc.util.Constant;
import com.lanto.shqixiu.shwgc.util.URLConnectionUtil;
import com.lanto.shqixiu.shwgc.util.excel.ExcelWriterPoiWriter;


@Controller
@RequestMapping(value="client/sys/vehiclecard",produces = "text/html;charset=UTF-8")
