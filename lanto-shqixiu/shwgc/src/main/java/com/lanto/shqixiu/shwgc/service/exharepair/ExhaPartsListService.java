...
public class ExhaPartsListService {
	...
	public Integer save(TbExhaustRepairPartsList pojo,ClientLoginInfo info) throws Exception{
	...
	public void update(TbExhaustRepairPartsList pojo,ClientLoginInfo info) throws SQLException{
