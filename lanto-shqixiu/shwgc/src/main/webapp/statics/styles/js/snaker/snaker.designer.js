(function(snaker){
    ...
    designer.util = {
        ...
        tip : function(rect, name) {
            ...
            tipDIV.style.top=document.getElementById('snakerflow').offsetTop+rect.attr('y')+55;
            tipDIV.style.width=180;
//            tipDIV.style.height=60;
            tipDIV.style.position="absolute";
            tipDIV.style.backgroundColor="#cbddf3";
            $.ajax({
                type:'GET',
                url:designer.config.ctxPath+"/manage/sys/task/tip",
                ...
                success: function(data){
                	...
                	tipDIV.innerHTML="<div style='width:180px; height:20px;border: 1px solid #d2dde2;'>" +
                			...
                			"</div><div style='border: 1px solid #d2dde2;color:#04408c;'>" +
                			"<div id='currentActorDIV' style=''><strong>参与者:</strong>" + ret.actors + "</div>" +
                			"<div id='arrivalDIV' style='color:#04408c;'><strong>抵达时间:</strong>" + ret.createTime + "</div></div>";
