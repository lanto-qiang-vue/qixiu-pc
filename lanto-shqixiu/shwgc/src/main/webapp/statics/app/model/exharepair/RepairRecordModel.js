Ext.define('app.model.exharepair.RepairRecordModel',{
	extend:'jsf.data.VO',
	fields:[
		...
		{name:'CO_CHECK' , type:'string', label:'CO',isShowGrid:false},
		{name:'CO_BEFORE_REPAIR' , type:'string', label:'CO',isShowGrid:false},
		{name:'CO_AFTER_REPAIR' , type:'string', label:'CO',isShowGrid:false},
		{name:'HC_CHECK' , type:'string', label:'HC',isShowGrid:false},
		{name:'HC_BEFORE_REPAIR' , type:'string', label:'HC',isShowGrid:false},
		{name:'HC_AFTER_REPAIR' , type:'string', label:'HC',isShowGrid:false},
		{name:'NO_CHECK' , type:'string', label:'NO',isShowGrid:false},
		{name:'NO_BEFORE_REPAIR' , type:'string', label:'NO',isShowGrid:false},
		{name:'NO_AFTER_REPAIR' , type:'string', label:'NO',isShowGrid:false},
		{name:'BTGXS_CHECK' , type:'string', label:'不透光系数',isShowGrid:false},
		{name:'BTGXS_BEFORE_REPAIR' , type:'string', label:'不透光系数',isShowGrid:false},
		{name:'BTGXS_AFTER_REPAIR' , type:'string', label:'不透光系数',isShowGrid:false},
		{name:'ZDLBGL_CHECK' , type:'string', label:'最大轮边功率',isShowGrid:false},
		{name:'ZDLBGL_BEFORE_REPAIR' , type:'string', label:'最大轮边功率',isShowGrid:false},
		{name:'ZDLBGL_AFTER_REPAIR' , type:'string', label:'最大轮边功率',isShowGrid:false}
	]
});