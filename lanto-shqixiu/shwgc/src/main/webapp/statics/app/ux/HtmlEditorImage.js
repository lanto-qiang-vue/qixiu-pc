...
zc.url = 'client/common/fileUpload/uploadEditor';
/**
* 获取小星星
* */
zc.getStar = function () {
...
*/
Ext.define('app.ux.HtmlEditorImage', {
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        items: [{
                            ...
                            fieldLabel: '选择文件',
                            beforeLabelTextTpl: '<span style="color:#FF0000;">*</span>',
                            buttonText: '请选择...',
                            name: 'upload',
                            emptyText: '请选择图片',
                            blankText: '图片不能为空',
    ...
    * */
    saveUploadImg: function (btn, view) {
        ...
        var values = formObj.getForm().getValues();
