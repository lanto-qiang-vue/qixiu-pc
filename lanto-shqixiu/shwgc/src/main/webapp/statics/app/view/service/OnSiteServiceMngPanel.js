Ext.define('app.view.service.OnSiteServiceMngPanel',{
	extend:'Ext.panel.Panel',
	alias: 'widget.service.OnSiteServiceMngPanel',
	itemId: 'service.OnSiteServiceMngPanel',
	...
	getSearchPanel : function(){
		...
		items :[{
			...
			model : 'app.model.service.OnSiteServiceModel',
			layout:'column',
			columns:5,
			labelWidth: 70,
			showType : 'search',
