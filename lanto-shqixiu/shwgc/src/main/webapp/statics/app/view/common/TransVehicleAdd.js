Ext.define('app.view.common.TransVehicleAdd',{
	extend:'Ext.window.Window',
	alias: 'widget.common.TransVehicleAdd',
	itemId: 'common.TransVehicleAdd',
	title: '添加运输车辆',
			...
			items : ['->',
					{
						...
						handler : function(btn){
							...
							if(data.IS_SINGLE){
								data.IS_SINGLE='10041001';
							}else{
								data.IS_SINGLE='10041002';
							}
							var params = {
							...
							var url = 'vehicle/transvehicle/save';
							app.utils.AjaxCallbackUtil.ajaxCallbackAll(url,params,function(ret){
								if( ret.success ){
									//me.getGridPanel().getStore().reload();
									win.callback();
	...
	getImageBtn:function(){
		...
		return {
	        ...
	        pluploadConfig:{       	
				...
				url :  '../vehicle/transvehicle/uploadImage',
