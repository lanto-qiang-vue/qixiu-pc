Ext.define('app.view.employee.TbEmployeeExpertApplyEdit',{
	extend:'Ext.window.Window',
	alias: 'widget.employee.TbEmployeeExpertApplyEdit',
	itemId: 'employee.TbEmployeeExpertApplyEdit',
	title: '从业人员基本信息',
...
//            clientValidation: true,
            ...
            success: function(response, action) {
               ...
               photo.setSrc("client/common/fileUpload/downloadPhoto?fileId=" + action.result.data);
	...
	loadData : function(record){
        ...
        if(!Ext.isEmpty(record.data.PHOTO)){
			photo.setSrc("client/common/fileUpload/downloadPhoto?fileId=" + record.data.PHOTO);
		}
	},
	//加载数据
