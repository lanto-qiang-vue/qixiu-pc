Ext.define('app.view.exharepair.RepairRecordsEdit',{
	extend:'Ext.window.Window',
	alias: 'widget.exharepair.RepairRecordsEdit',
	itemId: 'exharepair.RepairRecordsEdit',
	title: '维修开单',
...
//	autoScroll:true,
	...
	getItems : function(){
		...
		return {
			...
			url : 'exharepair/repairitemslist/list',
			columns : [
				...
				{fname:'PART_PHOTO',flex:1,align:'center',
                	...
                	listeners:{
                		click:function(a,b,c,d,e,f){
							...
							var win = Ext.create('app.view.exharepair.PartPhotoUpload');
            ...
            items:[{
				...
				store : Ext.create('Ext.data.Store', {
					...
					proxy: {
				        ...
				        url: 'exharepair/repairphoto/photolist'
				    },
				    autoLoad:false
				}),
				tpl: [
