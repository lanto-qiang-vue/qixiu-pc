Ext.define('app.view.sys.TqSysOperateLogMngPanel',{
	extend:'Ext.panel.Panel',
	alias: 'widget.sys.TqSysOperateLogMngPanel',
	itemId: 'sys.TqSysOperateLogMngPanel',
	...
	getSearchPanel : function(){
		...
		items :[{
			...
			model : 'app.model.sys.TqSysOperateLogModel',
			layout:'column',
			columns:4,
			labelWidth: 80,
			showType : 'search',
	...
	getGridPanel : function(){
		return {
			...
			rowSelType : 'MULTI',
			model : 'app.model.sys.TqSysOperateLogModel',
			url : 'client/sys/tqsysoperatelog/list',
			columns : [
