Ext.define('app.view.exharepair.RepairPhotoUpload',{
	extend:'Ext.window.Window',
	alias: 'widget.exharepair.RepairPhotoUpload',
	itemId: 'exharepair.RepairPhotoUpload',
	title: '维修图片上传',
	...
	loadData : function(params){
		var me = this;
		me.down('form').getForm().findField('RECORD_ID').setValue(params.RECORD_ID);
		me.down('form').getForm().findField('TAKE_TIME').setValue(new Date(),'Y-m-d H:i:s');
		me.down('form').getForm().findField('IMAGE_INFO').setValue('维修中照片');
	},
	getImageBtn:function(){
		...
		return {
	        ...
	        pluploadConfig:{       	
				...
				url :  '../exharepair/partslist/uploadImage',
