Ext.define('app.view.Viewport', {
	...
	listeners:{
		afterrender:function(){
			...
			var url = 'client/sys/common/getLoginUser';
			// 将全局登陆用户变量放入全局变量中
			app.utils.AjaxCallbackUtil.asyncCall(url,{}, function (Obj) {
				...
				window['GL'] = {
					...
					corpName:Obj.data.CORP_NAME,
					corpType:Obj.data.CORP_TYPE,
...
//			            '</li>',
			        	...
			        	'<li class="headerService menu1" code="WBM_CS"><i></i><span class="new-con-p">帮助</span>',
			        		'<ul class="container">',
			                    ...
			                    '<li class="menu2" onclick="location.href=\'http://www.xzinfo.com.cn/download/wxd_manual.docx\'"><a class="new-con header-quickStart">系统帮助</a></li>',
...
//            }
	...
	initComponent : function() {
        ...
        var todoPanel = Ext.create('app.view.report.RepairReportMngPanel',{
        	border:false,
        	closable : false,
	    ...
	    // 加载字典
		app.utils.DictUtil.loadDicts('client/sys/common/dict', {},
