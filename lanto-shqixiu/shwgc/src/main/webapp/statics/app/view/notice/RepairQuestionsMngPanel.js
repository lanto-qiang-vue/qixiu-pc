Ext.define('app.view.notice.RepairQuestionsMngPanel',{
	extend:'Ext.panel.Panel',
	alias: 'widget.notice.RepairQuestionsMngPanel',
	itemId: 'notice.RepairQuestionsMngPanel',
	...
	getSearchPanel : function(){
		...
		items :[{
			...
			model : 'app.model.notice.RepairQuestions',
			layout:'column',
			columns:5,
			labelWidth: 70,
			showType : 'search',
	...
	getGridPanel : function(){
		return {
			...
			collapsible:true,
			model : 'app.model.notice.RepairQuestions',
			url : 'notice/repairquestions/list',
			columns : [
