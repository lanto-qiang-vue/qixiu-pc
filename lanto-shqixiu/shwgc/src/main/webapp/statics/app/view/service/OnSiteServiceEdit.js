Ext.define('app.view.service.OnSiteServiceEdit',{
	extend:'Ext.window.Window',
	alias: 'widget.service.OnSiteServiceEdit',
	itemId: 'service.OnSiteServiceEdit',
	title: '服务确认',
		...
		me.items = [ {
			...
			items:[{
				...
				items: [
					...
					{fname:'ADDRESS',readOnly:true,width:438},
