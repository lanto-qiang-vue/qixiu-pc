Ext.define('app.view.credit.TbExamFileInfoAttach',{
	extend:'Ext.window.Window',
	alias: 'widget.credit.TbExamFileInfoAttach',
	itemId: 'credit.TbExamFileInfoAttach',
	title: '质量信誉考核附件上传',
	...
	initComponent : function() {
		...
		me.items = [ {
				...
				bodyPadding: 15,
				itemId:'npanel',
				html:'<div style="font-size:18px;line-height:20px;"><strong>&nbsp;&nbsp;&nbsp;&nbsp;企业网上申请需填报或上传以下资料：⑴上海市机动车维修企业质量信誉考核申请表（附件2）；⑵企业2014年度质量信誉工作总结；⑶机动车维修企业质量信誉考核评分表（由企业进行自评打分）；⑷企业获得相关表彰、奖励、荣誉的文件、证书复印件。以上资料网上提交后，需使用A4纸各打印１份，按以上顺序装订并加盖维修企业公章，待考核组现场考核时提交管理部门。</strong></div>'
			},{
	            xtype: 'uploadpanel',
	            title: '附件列表',
	            region:'center',
